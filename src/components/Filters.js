      ...
      <div className="content">
        <form onSubmit={(e) => e.preventDefault()}>
            ...
            <div className="colors">
              {
                colors.map((cat, index) => {
                  ...
                  return <button key={index} name="color" style={{ background: cat }} className={color === cat ? "color-btn active" : "color-btn"} data-color={cat}
                    onClick={updateFilters}>
                    {
          ...
          <div className="form-control">
            ...
            <input type="range" name='price' id='price' onChange={updateFilters}
             min={min_price} 
             max={max_price} 
             value={price}/>
          </div>
